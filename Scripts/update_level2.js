...
if (fattycurd.parameter_set["level2_begin"] === "<unknown>") {
	fattycurd.sound.play("level2_intro", false);
	var d = new Date();
	var begin_time = d.getTime();
	var loop = false;
	var level2_begin = true;
	var level0_timer = level0_maxtime;
} else {
	var level2_begin = JSON.parse(fattycurd.parameter_set["level2_begin"]);
...
if (fattycurd.parameter_set["tmp_bottlespeed_level2"] === "<unknown>") {
	var tmp_bottlespeed_level2 = [0.0,0.0];
	
} else {
	var tmp_bottlespeed_level2 = JSON.parse(fattycurd.parameter_set["tmp_bottlespeed_level2"]);
...
function v3Bottlespeed(direction) {
	return new fattycurd.vector3df(-direction[0]*tmp_bottlespeed_level2[0],0.0,direction[1]*tmp_bottlespeed_level2[1]);
...
var camera_dist = new fattycurd.vector3df(0,10,10);
...
if (UP) {
	if(!clicked[0]) {
		tmp_bottlespeed_level2[1] = 0.0;
		clicked[0] = 1;
	} else if (tmp_bottlespeed_level2[1] < bottlespeed) {
		tmp_bottlespeed_level2[1] += bottlespeed / bottle_duration;
	} else {
		tmp_bottlespeed_level2[1] = bottlespeed;
	}
	direction[1] = 1;
	last_direction[1] = 1;
	...
	direction[1] = 0;
	if (tmp_bottlespeed_level2[1] > 0.0) {
		tmp_bottlespeed_level2[1] -= bottlespeed / bottle_duration;
	} else {
		tmp_bottlespeed_level2[1] = 0.0;
	}
...
if (LEFT) {
	if(!clicked[2]) {
		tmp_bottlespeed_level2[0] = 0.0;
		clicked[2] = 1;
	} else if (tmp_bottlespeed_level2[0] < bottlespeed) {
		tmp_bottlespeed_level2[0] += bottlespeed / bottle_duration;
	} else {
		tmp_bottlespeed_level2[0] = bottlespeed;
	}
	direction[0] = 1;
	last_direction[0] = 1;
	...
	direction[0] = 0;
	if (tmp_bottlespeed_level2[0] > 0.0) {
		tmp_bottlespeed_level2[0] -= bottlespeed/bottle_duration;
	} else {
		tmp_bottlespeed_level2[0] = 0.0;
	}
...
euler.z = max_angle*last_direction[0]*(tmp_bottlespeed_level2[0]/bottlespeed + (bottle_wave).x);
euler.x = max_angle*last_direction[1]*(tmp_bottlespeed_level2[1]/bottlespeed + (bottle_wave).y);
...
for (obs_index in fattycurd.world.tiles) {
	...
	obs = obs.add(speed);
	var new_height = fattycurd.world.water.surfacePosition(obs.x/5, obs.y, obs.z/5);
	obs.y = new_height.y;
...
if (fattycurd.world.water.position.z > 25 && fattycurd.parameter_set["level2_event0"] === "<unknown>") {
	fattycurd.sound.play("level2_event0",false);
	fattycurd.parameter_set["level2_event0"] = JSON.stringify(true);
	
} else if (!(fattycurd.parameter_set["level2_event0"] === "<unknown>")) {
...
if (fattycurd.world.water.position.z > 50 && fattycurd.parameter_set["level2_event1"] === "<unknown>") {
	fattycurd.sound.play("level2_event1",false);
	fattycurd.parameter_set["level2_event1"] = JSON.stringify(true);
	
} else if (!(fattycurd.parameter_set["level2_event1"] === "<unknown>")) {
...
if (fattycurd.world.water.position.z > 75 && fattycurd.parameter_set["level2_event2"] === "<unknown>") {
	fattycurd.sound.play("level2_event2",false);
	fattycurd.parameter_set["level2_event2"] = JSON.stringify(true);
	
} else if (!(fattycurd.parameter_set["level2_event2"] === "<unknown>")) {
...
if (fattycurd.world.water.position.z > 100 && fattycurd.parameter_set["level2_event3"] === "<unknown>") {
	fattycurd.sound.play("level2_event3",false);
	fattycurd.parameter_set["level2_event3"] = JSON.stringify(true);
	
} else if (!(fattycurd.parameter_set["level2_event3"] === "<unknown>")) {
...
if (fattycurd.world.water.position.z > 125 && fattycurd.parameter_set["level2_event4"] === "<unknown>") {
	fattycurd.sound.play("level2_event4",false);
	fattycurd.parameter_set["level2_event4"] = JSON.stringify(true);
	
} else if (!(fattycurd.parameter_set["level2_event4"] === "<unknown>")) {
...
if (fattycurd.world.water.position.z > 150 && fattycurd.parameter_set["level2_event5"] === "<unknown>") {
	fattycurd.sound.play("level2_event5",false);
	fattycurd.parameter_set["level2_event5"] = JSON.stringify(true);
	
} else if (!(fattycurd.parameter_set["level2_event5"] === "<unknown>")) {
	var bill_pos = fattycurd.world.billboards[5].position;
	if (bill_pos.y < 30){
		bill_pos.y += 0.1;
		fattycurd.world.billboards[5].position = bill_pos;
	}	
}

if ( fattycurd.world.water.position.z > 175) {
	fattycurd.world.water.visible = false;
	fattycurd.parameter_set["fattycurd.menu.current"] = "level3";
}
...
if (begin_delta_time > 10000 && !loop) {
	loop = true;
	fattycurd.sound.play("level2_loop", true);
}

fattycurd.parameter_set["level2_begin"] = JSON.stringify(level2_begin);
fattycurd.parameter_set["tmp_bottlespeed_level2"] = JSON.stringify(tmp_bottlespeed_level2);
